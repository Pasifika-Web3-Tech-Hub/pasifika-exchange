...
contract DeployPasifikaFiatBridge is Script {
    function run() public returns (PasifikaFiatBridge) {
        ...
        bytes32 circleJobId = vm.envOr("CHAINLINK_CIRCLE_JOB_ID", bytes32(0x3862306630303966616335343461653938626633386166363935383735316664)); // Circle JobId
        bytes32 stripeJobId = vm.envOr("CHAINLINK_STRIPE_JOB_ID", bytes32(0x1234567890123456789012345678901234567890123456789012345678901234)); // Stripe JobId
