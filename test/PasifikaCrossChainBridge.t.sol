...
contract PasifikaCrossChainBridgeTest is Test {
    ...
    function testSendMessage() public {
        ...
        bytes32 messageId = bridge.sendMessage(PasifikaCrossChainBridge.SupportedChains.Arbitrum, receiver, messageData);
    ...
    function testSendTokens() public {
        ...
        bytes32 messageId =
            bridge.sendTokens(PasifikaCrossChainBridge.SupportedChains.Arbitrum, receiver, address(mockToken), 10 ether);
    ...
    function testUpdateChainConfig() public {
        ...
        vm.prank(owner);
        bridge.updateChainConfig(PasifikaCrossChainBridge.SupportedChains.Arbitrum, newChainSelector, newRouterAddress);
    }
    ...
    function testOnlyOwnerFunctions() public {
        ...
        vm.startPrank(user1);
        vm.expectRevert();
        bridge.updateChainConfig(PasifikaCrossChainBridge.SupportedChains.Arbitrum, 0x1234, address(0x1234));
    ...
    function testRevertWhenDestinationChainNotSupported() public {
        ...
        vm.prank(owner);
        bridge.updateChainConfig(PasifikaCrossChainBridge.SupportedChains.Linea, invalidChainSelector, address(router));
        ...
        vm.expectRevert();
        bridge.sendMessage(PasifikaCrossChainBridge.SupportedChains.Linea, receiver, abi.encode("This should fail"));
    ...
    function testRevertWhenInvalidReceiverAddress() public {
        ...
        bridge.sendMessage(PasifikaCrossChainBridge.SupportedChains.Arbitrum, address(0), abi.encode("To zero address"));
    ...
    function testRevertWhenNotEnoughLINK() public {
        ...
        vm.prank(owner);
        bridge.updateChainConfig(PasifikaCrossChainBridge.SupportedChains.Arbitrum, 0x6900aee69a5a8a14, address(router));
        ...
        vm.expectRevert();
        bridge.sendMessage(PasifikaCrossChainBridge.SupportedChains.Arbitrum, receiver, messageData);
