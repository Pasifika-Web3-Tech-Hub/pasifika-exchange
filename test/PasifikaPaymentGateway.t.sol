...
contract PasifikaPaymentGatewayTest is Test {
    ...
    function testNativePayment() public {
        ...
        uint256 paymentId = paymentGateway.processNativePayment{value: paymentAmount}(
            merchant,
            "Order-123"
        );
    ...
    function testNetworkNameUpdate() public {
        ...
        // Process a payment
        vm.prank(user1);
        uint256 paymentId = paymentGateway.processNativePayment{value: 0.1 ether}(
            merchant,
            "Network-Test-1"
        );
        ...
        vm.prank(user1);
        paymentId = paymentGateway.processNativePayment{value: 0.1 ether}(
            merchant,
            "Network-Test-2"
        );
